...
if __name__ == '__main__':
    ...
    feature_img_s = F.interpolate(feature_img_s.unsqueeze(0).unsqueeze(0), size=(84, 84), mode='bilinear', align_corners=False)
    feature_img_q = feature_img_q.squeeze.mean(dim=0)
    feature_img_q = F.interpolate(feature_img_q.unsqueeze(0).unsqueeze(0), size=(84, 84), mode='bilinear', align_corners=False)
