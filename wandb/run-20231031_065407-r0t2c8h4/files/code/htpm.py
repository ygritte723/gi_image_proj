...
if __name__ == "__main__":
    ...
    feature_img_s = feature_img_s.squeeze.mean(dim=0)
    ...
    feature_img_q = feature_img_q.squeeze.mean(dim=0)
    ...
    attn_heatmap_sca(feature_img_s, feature_img_q, attn_s, attn_q)
