...
def show_heatmap_on_image(img, attn):
    heatmap = cv2.applyColorMap(np.uint8(255 * attn), cv2.COLORMAP_PLASMA)
...
if __name__ == "__main__":
    # load data
    img_s_path = "/jet/home/lisun/work/xinliu/fewshot/Renet-MLTI/z-line.png"
    img_q_path = "/jet/home/lisun/work/xinliu/fewshot/Renet-MLTI/z-line_.jpg"
